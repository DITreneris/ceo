...
- **Community + FAQ hub UTM (2026-09-05)** — Explore-all-Hub and Product FAQ training links now `utm_source=ceo&utm_campaign=ecosystem` (`medium=community` / `faq`). Hero badge, hub map, methodology hint, address label stay bare. Entity footer unchanged. GEO robots not touched. Phase 15 paid path not reopened.
